...
./tpf_driver --type bootstrap --npart 40000 --output-file nkmp_p0_bootstrap.json
./tpf_driver --type resample --npart 40000 --output-file nkmp_p0_resample.json
./tpf_driver --npart 40000 --output-file nkmp_p0_tempered_40kr2.json
./tpf_driver --npart 40000 --rstar 3.0 --output-file nkmp_p0_tempered_40kr3.json
./tpf_driver --npart 4000 --output-file nkmp_p0_tempered_4kr2.json
./tpf_driver --npart 4000 --rstar 3.0 --output-file nkmp_p0_tempered_4kr3.json
./tpf_driver --type opt --npart 400 --output-file nkmp_p0_opt.json
